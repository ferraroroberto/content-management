...
from reporting.notion.notion_relations_python_setup import NotionRelationsPythonSetup
...
def main():
    ...
    log.info("  from reporting.notion.notion_relations_python_setup import NotionRelationsPythonSetup")
